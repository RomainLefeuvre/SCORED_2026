...
"""
This module Contains the original dataset used for testing the swh-graph
It is not used anymore, but it is kept here for reference
All the datasets are now in gitwebgraph/
"""
